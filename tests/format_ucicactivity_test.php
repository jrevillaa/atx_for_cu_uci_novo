...
/**
 * format_ucicactivity related unit tests
 *
 * @package    format_ucicactivity
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class format_ucicactivity_testcase extends advanced_testcase {
    ...
    public function test_update_course_numsections() {
        ...
        $course = $generator->create_course(array('numsections' => 10, 'format' => 'ucicactivity'),
    ...
    /**
     * Tests for format_ucicactivity::get_section_name method with default section names.
     */
    public function test_get_section_name() {
        ...
        $generator = $this->getDataGenerator();
        $numsections = 5;
        $course = $generator->create_course(array('numsections' => $numsections, 'format' => 'ucicactivity'),
            array('createsections' => true));
    ...
    /**
     * Tests for format_ucicactivity::get_section_name method with modified section names.
     */
    ...
    /**
     * Tests for format_ucicactivity::get_default_section_name.
     */
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_ucicactivity');
                ...
                $sectionname = $ucicactivityday.' - '.$enducicactivityday;
    ...
    public function test_update_inplace_editable() {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(array('numsections' => 5, 'format' => 'ucicactivity'),
            array('createsections' => true));
        $section = $DB->get_record('course_sections', array('course' => $course->id, 'section' => 2));

        // Call webservice without necessary permissions.
        try {
            core_external::update_inplace_editable('format_ucicactivity', 'sectionname', $section->id, 'New section name');
        ...
        $res = core_external::update_inplace_editable('format_ucicactivity', 'sectionname', $section->id, 'New section name');
    ...
    public function test_inplace_editable() {
        ...
        // Call callback format_ucicactivity_inplace_editable() directly.
        $tmpl = component_callback('format_ucicactivity', 'inplace_editable', array('sectionname', $section->id, 'Rename me again'));
