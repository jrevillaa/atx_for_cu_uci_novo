@format @format_ucicactivity
Feature: Sections can be edited and deleted in ucicactivity format
  In order to rearrange my course contents
  As a teacher
  I need to edit and Delete ucicactivity
  ...
  Background:
    ...
    And the following "courses" exist:
      ...
      | Course 1 | C1        | ucicactivity  | 0             | 5           | 957139200 |
  ...
  Scenario: View the default name of the general section in ucicactivity format
    When I click on "Edit section" "link" in the "li#section-0" "css_element"
    Then I should see "Use default section name [General]"

  Scenario: Edit the default name of the general section in ucicactivity format
    When I click on "Edit section" "link" in the "li#section-0" "css_element"
  ...
  Scenario: View the default name of the second section in ucicactivity format
    When I click on "Edit ucicactivity" "link" in the "li#section-2" "css_element"
    Then I should see "Use default section name [8 May - 14 May]"

  Scenario: Edit section summary in ucicactivity format
    When I click on "Edit ucicactivity" "link" in the "li#section-2" "css_element"
    And I set the following fields to these values:
  ...
  Scenario: Edit section default name in ucicactivity format
    Given I should see "8 May - 14 May" in the "li#section-2" "css_element"
    When I click on "Edit ucicactivity" "link" in the "li#section-2" "css_element"
    And I set the following fields to these values:
      | Use default section name | 0                       |
      | name                     | This is the second ucicactivity |
    And I press "Save changes"
    Then I should see "This is the second ucicactivity" in the "li#section-2" "css_element"
    And I should not see "8 May - 14 May" in the "li#section-2" "css_element"

  @javascript
  Scenario: Inline edit section name in ucicactivity format
    When I click on "Edit ucicactivity name" "link" in the "li#section-1" "css_element"
    And I set the field "New name for ucicactivity 1 May - 7 May" to "Midterm evaluation"
    And I press key "13" in the field "New name for ucicactivity 1 May - 7 May"
    Then I should not see "1 May - 7 May" in the "#region-main" "css_element"
    And "New name for ucicactivity" "field" should not exist
  ...
  Scenario: Deleting the last section in ucicactivity format
  ...
  Scenario: Deleting the middle section in ucicactivity format
    Given I should see "29 May - 4 June" in the "li#section-5" "css_element"
  ...
  Scenario: Deleting the orphaned section in ucicactivity format
  ...
  Scenario: Deleting a section when orphaned section is present in ucicactivity format
    When I follow "Reduce the number of sections"
    Then I should see "Orphaned activities (section 5)" in the "li#section-5" "css_element"
